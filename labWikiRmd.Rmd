...
Each graduate student will have a weekly 15-minute check-in meeting with me on every Monday. The purpose is to set the goal for the week as well as review your progress from the previous week. You must be prepared to provide an update and list of concrete actions/goals before the meeting. 
...
**Outlook.** You all have access to Microsoft's office suite through LSU. Please familiarize yourself with emails and calendars. All meeting invitations will be sent to your email as calender invites. Please RSVP when invited.
...
**Qualtrics.** All LSU students have access to an institutional license to Qualtrics, which is a survey/experiment builder. Please register for an account [here](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjf_7Xztab5AhVAlGoFHR8bBoEQFnoECAIQAQ&url=https%3A%2F%2Flsu.qualtrics.com%2F&usg=AOvVaw3YkdQETiG5CRp7pLwBUwZk)
...
The articles below are a collection of key papers for research in this lab. This reading list serves two purposes. First, it provides an overview of the research agenda of this lab. Second, it gives you a starting point for your literature review should you choose to conduct research in these areas. Graduate students required to be familiar with articles in this list to gain a general grasp of our research agenda. (Papers published by the lab can be found in the [OneDrive folder](https://lsumail2-my.sharepoint.com/:f:/g/personal/zhang1_lsu_edu/EiqXU6eWAi1DjZbF2qSpyecBOZzmhbqr1UlsezlLdsPu0g?e=V84od3))
...
Below is a list of journals in our field. It is important to keep up to date with research in your topic area as well as scholars in the field. To keep up with research, I suggest setting up email alerts of new articles. Most publishers have ways to set up email alerts. **Disclaimer:** The list below is not exhaustive nor is it a definitive list of 'good' journals. They are just the journals that I read and prefer based on my research interests. There are great journals (e.g., Journal of Occupational Health Psychology) not on this list simply because I don't publish in them. When deciding where to publish, it is important to find the journal that best suits your topic. However, the list below is a good place to start. 
...
* Send Dr. Don your website member profile and photo. 
...
* Set up essential software and accounts we use in in the lab (see Software and Accounts section of the manual)

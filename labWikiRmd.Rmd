...
My role is to oversee all research related activities in the RANDM Lab. As the lab Principal Investigator, I am responsible for providing researchers in the lab with various resources they need to succeed. However, as the PI, I also wear many hats such as teacher, mentor, and adviser. I will 
...
* Familiarity with the substantive, methodological, and empirical literature related to the lab's research activities (See lab publications). 

* Independently keeping up with current literature with respect to the overall research agenda of the lab. 
...
* As advanced students (post-masters), you should be initiating and leading independent research with the PI or other collaborators. 
...
As an adviser, I will supervise, direct, and support your research to the best of my ability. However, scientific research is unlike class work. There are often no 'right' answers. You are expected to be independent, self-motivated, and industrious. Your research is part of the RANDM lab, which means you may use lab resources in equipment, space, and personnel to complete your research. You will also be expected to present the result of your research at conferences and submitting it for publication in scientific journals.
...
Vacations are encouraged. Take them! Please observe LSU calendar for official holidays (e.g., Christmas, Mardi Gras, etc). You should also take some time off during the summer (3 weeks, with flexibility. Please notify Don when away from office/computer). However, summers are prime time for research and writing due to reduced course and teaching obligations. Thus, you are expected to be working on research (e.g., working towards publications) and degree milestone (e.g., thesis and dissertations) during summer months. I expect you to be working at least 20 hours per week on research activities and/or professional development (e.g., acquiring new skills). Individual arrangements may vary for students on full-time external internships or grants. Please speak with Don before each summer regarding your summer plans. 

## Communication

All lab-related communications are contained on Slack, which is a real-time team-based communication platform. Slack can be accessed via your web browser (e.g., Google Chrome), as a Desktop app, and as a Mobile app. 

You are expected to check and respond to emails and Slack messages in a timely manner to keep updated on lab announcements and project-related discussions. This means responding to messages within 36 business hours maximum (even if this means a thumbs-up emoji). If you receive emails or Slack messages from me during non-business hours, you are not obligated or expected to respond until you return to the office.
...
Each graduate student will have a weekly 15-minute check-in meeting with me on every Monday. The purpose is to set the goal for the week as well as review your progress from the previous week. You should be prepared with a list of completed tasks from the week before, an update on current project status, and a list of actions for the current week. This should be done on Todoist.  

We will have bi-weekly 1-hour full lab meetings for research activities such as article readings, brainstorming sessions, research presentation, or other professional development activities (e.g., mini-workshops). Graduate students may be asked to lead article discussions, research presentations, or mini workshops. Other project-specific meetings will be held on a as-needed basis. 
...
Graduate students are expected to significantly contribute to research within the lab. *Authorship* on research outputs (manuscripts, posters, etc) is given to individuals who made meaningful and substantial *intellectual contributions,* which include, but are not limited to, significant contribution to literature synthesis, theory development, research design, hypotheses generation, data analysis, and manuscript writing/editing. 

All projects will have a *lead researcher* (typically Don or a senior graduate student). The lead researcher is responsible for directing the research effort, delegating tasks, and actively moving the project forward. The lead researcher is usually responsible for the first draft of the final manuscript. Graduate students who provide supporting roles (e.g., data analysis, literature review) are expected to complete the assigned task in a timely manner. 

While I will try to be be transparent and clear about authorship roles at early stages of the project. However, new authors may be added to a project based on their contributions at later stages of the project. And existing authors may be demoted or removed if they fail to fulfill their responsibilities and complete the necessary research tasks in an accurate and timely manner. 
...
**Theses, Dissertation, and Independent Research**. Thesis and dissertation studies are led by the graduate student and supervised by me. In addition, graduate students are encouraged to pursue independent research studies during their time at LSU. The graduate student will have first priority to lead research outputs (e.g., conference presentations and publications) resulting from theses and dissertations, with guidance from me. In events where the student chooses not to pursue publication with their thesis and dissertation study, I reserve the right to use data collected by the student for publication. The graduate student will always be included in any research output resulting from a thesis or dissertation. Authorship order on the final manuscript will depend on overlap with their dissertation. Usually, if a paper is published completely with the graduate student's data/study and based on their primary propositions, the graduate student will remain as the first author. However, if the thesis/dissertation data is used as part of a multi-study paper led by me, or if the paper has been significantly re-framed and re-written such that key hypotheses/propositions are new, the graduate student may be positioned as a supporting author, if their level of contribution no longer satisfies the requirements of a first author. In all of the situations described above, the student should consult with me on decisions involving publications based on a thesis/dissertation/independent project. I will always prioritize the graduate's decisions with regard to how their study will be used. 
...
**SONA Researcher Account** Graduate students and RAs who are actively involved in data collection via the SONA subject pool must obtain a researcher account. You may request an account by emailing (cc Don and the graduate student PI (if applicable)) the SONA administrator (researchadmin@lsu.edu)
...
**Jamovi.** Jamovi is an user-friendly and open-source statistical software. Students may use Jamovi for their first project (e.g. undergraduate) but are required to move onto R as soon as possible. For graduate students, jamovi may be used as a supplemental tool but all final analyses needs to be done in R (See library(jmv) for how to use Jamovi in conjunction with R).

**Zotero** is a open-source citation manager. I *very highly* recommend that you use Zotero for managing your papers and creating your citations. A great tutorial can be found [here](https://lsumail2-my.sharepoint.com/:b:/g/personal/zhang1_lsu_edu/EbjGUJnqNulJiGjhUNjyhasByat7s-4o1kFvtA32FhZA9w?e=0zbfXG)
...
4. other optional tags include: @errands, @email, @campus. 

## Github and Version Control

All lab members involved in data analysis should have a GitHub.com account and download the GitHub Desktop for their computer. Github should be used for individual and collaborative projects. All individual projects, including thesis, must be on GitHub and always updated (more on version control later). Published and working manuscripts are stored in the Manuscripts folder in the RANDM Lab. 
...
Everyone may have personal preferences on how to manage their digital lives and files. Although I believe that is critical for every lab members to maintain a tidy and organized digital working space, I will not supervise or micro-manage how you organize your files on your personal computers. However, I do expect the following when it comes to work related to the lab, including your theses/dissertations. 

1) You must maintain updated version of the project on GitHub at all times. In other words, every time you make progress on a project, your work must be pushed to GitHub. 

2) You may write your manuscripts anywhere and using any software. But you must maintain an updated version of working manuscripts in the One Drive folder regularly. 

3) You must learn/adhere to the workflow conventions with respect to statistical analysis when working on a project in this lab. You must write code that *anyone* in this lab can understand and replicate. 

4) You must learn to use R for statistical analyses. You may use other software (e.g., MPlus, SPSS, JAMOVI) for specific purposes, but any general analyses must be done in R. 

# Resources

## Funding

The RANDM Lab current has funding from the [National Science Foundation](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2142891&HistoricalAwards=false) (2022 to 2027) to conduct research on workplace risk taking. Research activities that advance the aims of the grant ([Read the project description here](https://lsumail2-my.sharepoint.com/:w:/r/personal/zhang1_lsu_edu/Documents/RANDM%20LAB/Manuscripts/WorkingPapers/NSF/NSF_ProjDescrip_Short.doc?d=webf213a7f08945e6964b3a7ff30fb306&csf=1&web=1&e=tzgypI)) may be eligible to receive funding for research projects (e.g., theses/dissertations). Lab members who present grant-related work are eligible to receive travel funding for one conference per year. Details on eligibility and award amount are found below. 

1) Students who are presenting grant-funded work as a lead author will receive $1000 in support toward their trip, provided they apply for the graduate college travel reward and the HSS travel reward.  

2) Students who are presenting grant-funded work as a supporting author will receive $500 in support toward their trip. 

3) Students who submits grant-funded work (e.g., to SIOP) but is rejected will receive $500 in travel support. 

## Key Readings

The articles below are a collection of key papers for research in this lab. This reading list serves two purposes. First, it provides an overview of the research agenda of this lab. Second, it gives you a starting point for your literature review should you choose to conduct research in these areas. (Papers published by the lab can be found in the [OneDrive folder](https://lsumail2-my.sharepoint.com/:f:/g/personal/zhang1_lsu_edu/EiqXU6eWAi1DjZbF2qSpyecBOZzmhbqr1UlsezlLdsPu0g?e=V84od3))
...
Below is a list of journals in our field. It is critical to keep up to date with research in your topic area as well as scholars in the field. To do so, I suggest setting up email alerts of new articles. Most publishers have ways to set up email alerts. Regardless of how you do it, you must be reading at least the titles and abstracts of new articles published in our field journals regularly.

**Disclaimer:** The list below is not exhaustive nor is it a definitive list of 'good' journals. They are just the journals that I read and prefer based on my research interests. There are journals (e.g., Journal of Occupational Health Psychology) not on this list. When deciding where to publish, it is important to find the journal that best suits your topic. However, the list below is a good place to start. 

For more information about journals not listed here, see *[Journal Citation Reports](https://jcr-clarivate-com.libezp.lib.lsu.edu/JCRLandingPageAction.action?Init=Yes&SrcApp=IC2LS&SID=H1-hfMhfOetjR5x2BS8b3kRbwpw5N2f363uyG-18x2d6GyQxxFugKPUa4tn0JGiq6Ax3Dx3DXI8H1iMG7OaDHqL5X7hMVQx3Dx3D-03Ff2gF3hTJGBPDScD1wSwx3Dx3D-cLUx2FoETAVeN3rTSMreq46gx3Dx3D)* 

**IO Psychology, HR Management, Organizational Behavior**
...
- [Personality Project for R](http://personality-project.org/r/)
- [R for Data Science](https://r4ds.had.co.nz/index.html)

## Utilities and Web Apps

- [Mediation Power Analysis Web App](https://davidakenny.shinyapps.io/MedPower/)
- [Power Analysis for General ANOVA](https://jakewestfall.shinyapps.io/pangea/)
- [Shiny App for Meta-Analysis](http://kylehamilton.net/shiny/MAVIS/)
- [Relative Weights Analysis Shiny App](https://kamalyunus.shinyapps.io/relweights/)
- [interActive - Visualizing Interactions](https://connorjmccabe.shinyapps.io/interactive/)
- [zoteroBib - Bibliography Generator](https://zbib.org/)
- [Interaction Power Analysis Shiny App](https://david-baranger.shinyapps.io/InteractionPoweR_analytic/)
...
* Check out the [RANDM Lab website](https://randmlab.owlstown.net/)
* Send Don your website member profile and photo. 
...
* Read the entire Lab Manual (Find link in the Wiki channel on Slack) 
...
* Graduate students must read abstracts of recently-published articles in this lab to familiarize with lab's current research.
* small changes

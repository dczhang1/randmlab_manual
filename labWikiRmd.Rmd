...
Graduate students should treat your PhD as a full-time job. This means expecting to work between regular business hours (9 to 5), Mon – Fri. 
Although research in academia is flexible and remote work is possible, lab members are expected to be on campus/in office at least 3 days a week to maximize collaboration, intellectual engagement, and building camaraderie. Ultimately, I encourage you to find what works for you for getting work done but also contribute to the culture-building and collaborative needs of the lab.

Vacations are encouraged. Take them! Please observe LSU calendar for official holidays (e.g., Christmas, Mardi Gras, etc). You should also take some time off during the summer (3 weeks, with flexibility. Please notify Don when away from office). However, summers are prime time for research due to reduced course and teaching obligations. Thus, you are expected to be working on research (e.g., preparing for SIOP submissions) and degree milestone (e.g., thesis) during summer months (at a slightly reduced load). Generally, this means that I expect you to be working between 20 and 30 hours per week. Individual arrangements may vary for students on full-time external internships or grants. Please speak with Don before each summer regarding your summer plans.  

We encourage lab members to disconnect ad maintain healthy work-nonwork boundaries. You are, however, expected to check and respond to emails and Slack messages in a timely manner to keep updated on lab announcements and project-related discussions. This means responding to messages within 48 business hours (even if this means a thumbs-up emoji on Slack messages, we love technology :). If you receive emails or Slack messages from me during odd hours, you are not obligated or expected to respond. You're also welcome to work away from campus from time to time or on days when you have no in-person obligations (e.g., classes). 
...
4. When messaging one person, please use DMs instead of "@" in channel.

5. Set appropriate notification and Do-not-disturb settings.
...
[**Github**](github.com) Github is recommended for version control and is particularly useful when working in R.
...
**GitKraken** GitKraken is a desktop client for Git. All students working on statistical analyses are encouraged to use GitKraken version control and collaborative research. 
